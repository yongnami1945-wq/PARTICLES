...
export const VisualTimelineEditor: React.FC<VisualTimelineEditorProps> = ({
  ...
  return (
    <div className={`bg-[#0E0E12] border border-[#26262E] p-3.5 space-y-3.5 select-none font-mono ${className}`}>
      {/* 1. Header Toolbar */}
      <div className="flex flex-wrap items-center justify-between gap-2 pb-2.5 border-b border-[#222228]">
        <div className="flex items-center gap-2">
          <div className="p-1.5 bg-[#FFE600]/15 text-[#FFE600] border border-[#FFE600]/40">
            <Zap className="w-4 h-4" />
          </div>
          <div>
            <div className="text-xs font-bold text-white uppercase tracking-wider flex items-center gap-1.5">
              <span>비주얼 타임라인 시퀀스 에디터 (TIMELINE CHAIN)</span>
        ...
        <div className="flex items-center gap-1.5 flex-wrap">
          <button
            ...
            className="px-2.5 py-1 bg-[#FFE600]/15 hover:bg-[#FFE600] hover:text-black text-[#FFE600] border border-[#FFE600] text-[10px] font-bold uppercase transition flex items-center gap-1 cursor-pointer shadow-[0_0_8px_rgba(255,230,0,0.15)]"
          ...
          <button
            ...
            className="px-2 py-1 bg-[#1A1A22] hover:bg-[#2A2A35] text-gray-300 hover:text-white border border-[#33333E] text-[10px] font-bold uppercase transition flex items-center gap-1 cursor-pointer"
            ...
            return (
              <React.Fragment key={`timeline-station-${index}-${shapeId}`}>
                ...
                <div
                  ...
                  className={`shrink-0 w-52 p-2.5 border-2 transition-all duration-200 relative group cursor-grab active:cursor-grabbing ${
                    isDragging
      ...
      <div className="pt-2.5 pb-1 border-t border-[#222228]">
        <div className="flex flex-wrap items-center justify-between gap-2 mb-2">
          <div className="flex items-center gap-2">
            <div className="text-[10px] font-bold text-[#FFE600] uppercase tracking-wider flex items-center gap-1.5">
              ...
              <span>모핑 가속도 이징 곡선 (MORPH EASING ACCELERATION)</span>
            </div>
            <span className="text-[9px] px-1.5 py-0.5 bg-[#FFE600]/10 text-[#FFE600] border border-[#FFE600]/40 font-mono">
              ACTIVE: {(config.morphEasing || 'ease-in-out').toUpperCase()}
            </span>
          </div>
          <span className="text-[9px] text-gray-400">
            구간별 경유지(Waypoint) 통과 시 파티클 가속/감속 궤적을 제어합니다.
          </span>
        </div>
      ...
      <div className="pt-2 border-t border-[#222228]">
        <div className="flex items-center justify-between mb-2">
          <div className="text-[10px] font-bold text-gray-400 uppercase tracking-wider flex items-center gap-1.5">
            ...
            <span>원클릭 다단계 시퀀스 템플릿 (PRESET TEMPLATES)</span>
          </div>
          <span className="text-[9px] text-gray-500">클릭 즉시 전체 시퀀스 자동 구성</span>
        </div>
